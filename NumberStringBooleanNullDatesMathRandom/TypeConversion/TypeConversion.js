...
console.log("Value of num cast to booelan: ", Boolean(num));

console.log("Value of str cast to booelan: ", Boolean(str));

console.log("Value of date cast to booelan: ", Boolean(date));

console.log("Boolean value of 0 : ", Boolean(0));

console.log("Boolean value of blanck string : ", Boolean(""));
